...
echo ' <div class="col-md-12"><div class="panel panel-default"><div class="panel-heading"><h3>'. __('LiveForm Add-Ons','liveforms').'</h3></div><div class="panel-body">All Live Form Add-ons</div></div></div>';
