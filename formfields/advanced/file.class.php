...
class File {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="File">
			<span class="lfi lfi-name"></span> File 
			<a title="File" rel="File" class="add" data-template='File' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
		</li>
		<?php
