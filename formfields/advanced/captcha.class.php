...
class Captcha {
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Captcha">
			<span class="lfi lfi-name"></span> Captcha 
			<a title="Captcha" rel="Captcha" class="add" data-template='Captcha' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
	</li>
	    <?php
