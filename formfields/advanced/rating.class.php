...
class Rating {
	...
	public function control_button() {
		...
		<li class="list-group-item" data-type="<?php echo __CLASS__ ?>" for="Rating">
			<span class="lfi lfi-name"></span> Rating 
			<a title="Rating" rel="Rating" class="add" data-template='Rating' href="#"><i class="glyphicon glyphicon-plus-sign pull-right ttipf" title=""></i></a>
	</li>
	    <?php
