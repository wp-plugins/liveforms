...
<tr><td><label>'.__("Notify Url:","liveform").'</label></td><td><input class="form-control" type="text" name="'.$fieldprefix.'[Paypal][notify_url]" value="'.(isset($cache['notify_url']) ? $cache['notify_url'] : "").'" /></td></tr>
